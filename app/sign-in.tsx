...
const signin = () => {
  ...
  <Text className="text-base text-center uppercase font-rubik text-black-200">Welcome to Vancouver Homes</Text>
  <Text className="text-3xl font-rubik-bold text-black-300 text-center mt-2">Your dream home awaits!{'\n'}
